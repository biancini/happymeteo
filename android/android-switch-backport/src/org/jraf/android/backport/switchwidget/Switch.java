...
public class Switch extends CompoundButton {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //Log.i(TAG, "mThumbTextPadding: "+mThumbTextPadding);
    ...
    private Layout makeLayout(CharSequence text) {
    	...
    	float width = Layout.getDesiredWidth(text, mTextPaint);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //Log.i("android-switch-backport", "switchInnerLeft: "+switchInnerLeft); 
        //Log.i("android-switch-backport", "mTempRect.right: "+mTempRect.right); 
        //Log.i("android-switch-backport", "mThumbWidth: "+mThumbWidth); 
        //Log.i("android-switch-backport", "thumbLeft: "+thumbLeft);
        //Log.i("android-switch-backport", "thumbRight: "+thumbRight);
        //Log.i("android-switch-backport", "thumbPos: "+thumbPos);
