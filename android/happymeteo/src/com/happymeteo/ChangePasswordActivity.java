...
public class ChangePasswordActivity extends AppyMeteoNotLoggedActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final ImageView changePassword_imageCaptcha = (ImageView) findViewById(R.id.changePassword_imageCaptcha);
        ...
        final Captcha captcha = new TextCaptcha(changePassword_textCaptcha.getWidth(), changePassword_textCaptcha.getHeight(), 5, TextOptions.NUMBERS_AND_LETTERS);
