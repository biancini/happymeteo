...
public class InformationPageActivity extends AppyMeteoLoggedActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String help = "<html><body>" +
				...
				"Lo diciamo perchè, oltre al divertimento di usare la app, stai contribuendo a qualcosa di utile per tutti. " +
				...
				"&#8226; Innanzitutto, perchè è divertente<br/>" +
				"&#8226; E poi perchè ogni risposta ti fa guadagnare punti, così come invitare i tuoi amici a scaricare l'app e giocare. E una classifica aggiornata ti dirà dove ti posizioni. <br/><br/>" +
